...
GST_PLUGIN_DEFINE(GST_VERSION_MAJOR, GST_VERSION_MINOR, toupcamsrc,
                  "ToupCam camera source element.", plugin_init, VERSION,
                  "BSD", PACKAGE_NAME, "http://www.touptek.com")
